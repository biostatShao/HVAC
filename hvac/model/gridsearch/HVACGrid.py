...
from hvac.model.HVAC import HVAC
from ..vi.e_step import e_step_grid
from ..vi.e_step_cpp import cpp_e_step_grid
from hvac.utils.compute_utils import dict_mean
from hvac.utils.OptimizeResult import OptimizeResult
...
class HVACGrid(HVAC):
    ...
    def to_theta_table(self):
        ...
        if self.n_models == 1:
            return super(HVACGrid, self).to_theta_table()
